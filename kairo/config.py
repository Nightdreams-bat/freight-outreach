...
from kairo.paths import CONFIG_PATH, DEFAULT_EXCEL_PATH
...
DEFAULTS = {
    ...
    # Multi-touch follow-up drip (kairo/send_followups.py). Off until the
    ...
    # Rules-based lead priority (kairo/scoring.py) - used to order the send
    ...
    "daily_send_cap": 20,
    # LLM spend guardrail (kairo/llm_tracker.py). Nothing caps Claude calls
...
def default_config(lang=None):
    ...
    return {
        ...
        # "auto-detect from the sheet's own headers" (kairo/column_map.py).
        "column_map": {},
        "gmail_address": "",
        "disallowed_domains": [],
        "disallowed_emails": [],
